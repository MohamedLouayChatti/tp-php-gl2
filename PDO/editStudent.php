...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['confirm']) && isset($_POST['studentId'])) {
        ...
        if(!$validSection){
            ...
            $etudiant = (object)['id' => $id,'name' => $name,'section' => $section, 'dateDeNaissance' => $birthday];
        }else{
            ...
            $etudiantsRepository->update($id, ['name' => $name,'section' => $section,'dateDeNaissance' => $birthday,'imageURL' => $newImagePath]);
...
<body>
    <div class="bg-white p-4 rounded-3 shadow-lg w-100" style="max-width: 400px;">
        <h2 class="register-title">Update the information of <?=$etudiant->name?></h2>
        <form action="editStudent.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group mb-3">
                ...
                <input type="text" class="form-control" name="name" value="<?= $etudiant->name ?>" required>
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <input type="text" class="form-control" name="section" value="<?= $etudiant->section ?>" required>
            </div>

            <div class="form-group mb-3">
                <label for="birthday">Date de naissance</label>
                <input type="date" class="form-control" name="birthday" value="<?= $etudiant->dateDeNaissance ?>" required>
            </div>
            ...
            <div class="form-group d-flex">
                <button type="submit" name="confirm" class="form-control btn btn-danger me-2">Save changes</button>
